  ...
  arn_y/.style = {treenode, circle , yellow, draw=yellow, 
    ...
    \maketitle
     \begin{tikzpicture}
      ...
      \node[punkt] at (-5,0) (7) {Simulation \\ {\scriptsize État global + \\ Règles d'évolution\\}};
      \node[punkt] at (-5,-4) (8) {Scénario \\ {\scriptsize Règles de réaction globales\\}};
      ...
      \draw[->,black,thick] (7) to[out=54,in=-45] node [midway,below] {updates locales \\ / client} (10);
