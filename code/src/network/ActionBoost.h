...
BOOST_CLASS_EXPORT(A_Pick);
BOOST_CLASS_EXPORT(CoA_Pick);
BOOST_CLASS_EXPORT(A_Kick);
BOOST_CLASS_EXPORT(CoA_Kick);
BOOST_CLASS_EXPORT(A_Shoot);
BOOST_CLASS_EXPORT(CoA_Shoot);
BOOST_CLASS_EXPORT(A_Reload);
BOOST_CLASS_EXPORT(CoA_Reload);
BOOST_CLASS_EXPORT(A_Plant);
BOOST_CLASS_EXPORT(CoA_Plant);
BOOST_CLASS_EXPORT(A_Drop);
BOOST_CLASS_EXPORT(CoA_Drop);
...
BOOST_CLASS_EXPORT(C_FakeStuff);
BOOST_CLASS_EXPORT(C_Flower);
#endif